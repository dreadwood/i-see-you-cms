...
export interface ApiLandingLanding extends Schema.SingleType {
  ...
  attributes: {
    heroSection: Attribute.Component<'landing.hero'> & Attribute.Required;
    courseDescriptionSection: Attribute.Component<'landing.course-description-section'>;
    whyNeedSection: Attribute.Component<'landing.why-need-section'>;
    aboutAuthorSection: Attribute.Component<'landing.about-author-section'>;
    curatorsSection: Attribute.Component<'landing.curators-section'>;
    programSection: Attribute.Component<'landing.program-section'>;
    programListSection: Attribute.Component<'landing.dropdown', true>;
    feedbackSection: Attribute.Component<'landing.feedback-section'>;
    aboutCourseSection: Attribute.Component<'landing.about-course-section'>;
    registrationSection: Attribute.Component<'landing.registration-section'>;
    footerSection: Attribute.Component<'landing.footer-section'> &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
